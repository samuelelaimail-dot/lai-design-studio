...
(function () {
  ...
  function labelFor(state) {
    ...
    return (labels[lang] || labels.en)[state];
  }
  ...
  button.type = "button";
  button.textContent = labelFor("paused");
  ...
  function setState(state) {
    ...
    control.classList.toggle("is-blocked", state === "blocked");
    button.textContent = labelFor(state);
  ...
  const originalApplyLanguage = window.applySiteLanguage;
